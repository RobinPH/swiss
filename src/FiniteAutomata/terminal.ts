...
export const VALUE = OR(INTEGER, STRING, BOOLEAN_VALUE_KEYWORD).setValue(
  "VALUE"
);
...
export const MODULO_OPERATOR = ATOM("%").setValue("MODULO_OPERATOR").token();
...
// Null Keyword
export const NULL_KEYWORD = WORD("null").setValue("NULL_KEYWORD").token();

//Exception Keyword
export const TRY_KEYWORD = WORD("try").setValue("TRY_KEYWORD").token();

export const CATCH_KEYWORD = WORD("catch").setValue("CATCH_KEYWORD").token();

export const FINALLY_KEYWORD = WORD("finally")
  .setValue("FINALLY_KEYWORD")
  .token();

export const RAISE_KEYWORD = WORD("raise").setValue("RAISE_KEYWORD").token();
...
//Return Keyword
export const RETURN_KEYWORD = WORD("return").setValue("RETURN_KEYWORD").token();
