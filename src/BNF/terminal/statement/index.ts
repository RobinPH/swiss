...
import { CONST_DECLARATOR, DECLARATOR } from "../declarator";
import {
...
export const CLASS_INSTANCE_VARIABLE = CONCAT(
  OPTIONAL(CONCAT(DATATYPE_SPECIFIER, WHITESPACE)),
  IDENTIFIER,
  WHITESPACE,
  OPTIONAL(CONCAT(ASSIGNMENT_OPERATOR, WHITESPACE, VALUE)),
  SEMICOLON
).name("CLASS_INSTANCE_VARIABLE");
...
export const CLASS_CODE_BLOCK = CONCAT(
  OPENING_CURLY,
  WHITESPACE,
  STAR(CONCAT(OR(CLASS_METHOD, CLASS_INSTANCE_VARIABLE), WHITESPACE)),
  WHITESPACE,
  CLOSING_CURLY
).name("CLASS_CODE_BLOCK");
...
export const CLASS_DECLARATION = CONCAT(
  ...
  NON_EMPTY_WHITESPACE,
  OPTIONAL(
    CONCAT(CLASS_EXTENDS_KEYWORD, NON_EMPTY_WHITESPACE, IDENTIFIER, WHITESPACE)
  ),
  CLASS_CODE_BLOCK
