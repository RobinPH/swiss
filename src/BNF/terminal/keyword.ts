...
export const BOOLEAN_DATA_TYPE_KEYWORD = CONCAT(
  ...
  OPTIONAL(WORD("ean")).name(Token.BOOLEAN_NOISE_WORD)
)
...
//ARRAY_KEYWORD
export const ARRAY_DATA_TYPE_KEYWORD = WORD("array")
  .name(Token.ARRAY_DATA_TYPE_KEYWORD)
  .token();
