...
export const INTEGER_DATA_TYPE_KEYWORD = WORD("int").name("INTEGER_DATA_TYPE_KEYWORD").token();
export const FLOAT_DATA_TYPE_KEYWORD = WORD("float").name("FLOAT_DATA_TYPE_KEYWORD").token();

//CHARACTER KEYWORD
export const CHARACTER_DATA_TYPE_KEYWORD = WORD("char").name("CHARACTER_DATA_TYPE_KEYWORD").token();
//STRING KEYWORD
export const STRING_DATA_TYPE_KEYWORD = WORD("string").name("STRING_DATA_TYPE_KEYWORD").token();
//BOOLEAN KEYWORD
export const BOOLEAN_DATA_TYPE_KEYWORD = CONCAT(
  ...
  .name("BOOLEAN_DATA_TYPE_KEYWORD")
  .token();
